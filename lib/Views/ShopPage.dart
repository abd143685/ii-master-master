                                  ...
                                  TypeAheadFormField(
                                    ...
                                    suggestionsCallback: (pattern) {
                                      return [
                                        ...
                                        'Wah Cantonment', 'Washap', 'Wasjuk', 'Yakmach'
                                    ...
                                    onSuggestionSelected: (suggestion) {
                                      ...
                                      if (['Adezai', 'Ahmed Nager Chatha', 'Ahmedpur East', 'Ali Bandar', 'Ali Pur', 'Amir Chah', 'Arifwala', 'Astor', 'Attock', 'Ayubia',
                                        ...
                                        'Turbat', 'Umarao', 'Umarkot', 'Uthal', 'Vehari', 'Veirwaro', 'Vitakri', 'Wadh', 'Wah Cantonment', 'Washap', 'Wasjuk', 'Yakmach'
                                      ].contains(suggestion)) {
                                        setState(() {
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () async {
                                      if (shopNameController.text.isNotEmpty &&
                                        ...
                                        // Get current latitude and longitude from CurrentLocationScreen
                                        ...
                                        String shopid =
                                        await shopViewModel.fetchLastShopId();
                                        ...
                                        // Show toast message for invalid input or missing location
                                        Fluttertoast.showToast(
                                          msg: 'Please fill all fields and add a location before saving.',
                                          toastLength: Toast.LENGTH_SHORT,
                                          gravity: ToastGravity.BOTTOM,
                                          timeInSecForIosWeb: 1,
