...
//   final List<AttendanceModel> savedShopData;
//
...
//   List<AttendanceModel> _shopList = [];
//
//
//   @override
//   void initState() {
...
//             Text('Owner Name: ${shop.ownerName ?? "N/A"}'),
//             Text('Owner CNIC: ${shop.ownerCNIC ?? "N/A"}'),
//             Text('Phone Number: ${shop.phoneNo ?? "N/A"}'),
