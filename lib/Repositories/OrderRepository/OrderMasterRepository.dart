...
class OrderMasterRepository{
  ...
  Future<List<OrderMasterModel>> getShopVisit() async{
    ...
    List<Map> maps = await dbClient!.query('orderMaster',columns: ['orderId','date','shopName','ownerName','phoneNo','brand','userId','userName','total','creditLimit','discount','subTotal','requiredDelivery']);
